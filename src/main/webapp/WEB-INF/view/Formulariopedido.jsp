...
<br>
  ...
  <hr>
   ...
   <!--  para usarlo en la parte de modificar el registro ya que carga el id tambien al recuperar el registro-->  
     ...
     <table border="1">
      <tr>
      <td id="cabecera">numpedido</td><td><form:input path="numpedido" /></td>
      </tr>
      <tr>
     <td id="cabecera">fecha</td><td><form:input path="fecha" /></td>
     </tr>
     <tr>
     <td id="cabecera">importe</td><td><form:input path="importe" /></td>
     </tr>
     <tr>
     <td id="cabecera">descuento</td><td><form:input path="descuento" /></td>
     </tr>
     <tr>
     <td id="cabecera">idCliente</td><td><form:input path="idCliente" /></td>
     </tr>
     <tr>
     <td colspan="2"><button class="btn btn-primary btn-lg" type="submit"> &nbsp;insertar/actualizar</button></td>
     </tr>
  </table>
...
<br>
<br>
<button class="btn btn-outline-dark" onclick="window.location.href='lista2';" type="button">Regresar</button>
</center>
<br>
<br>
<br>
