...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="lista3">Gestión Artículo</a>
      </li>
    </ul>
...
<c:forEach var="articulosTemp" items="${articulos}">

<c:url var="linkActualizarA" value="/cliente/muestraFormularioActualizarArticulos">
<c:param name="idArticulo" value="${articulosTemp.idArticulo}"/>
</c:url>

<c:url var="linkEliminarA" value="/cliente/eliminarArticulo">
<c:param name="idArticulo" value="${articulosTemp.idArticulo}"/>
</c:url>

<tr>
<td>${articulosTemp.idArticulo}</td>
<td>${articulosTemp.nombre}</td>
<td>${articulosTemp.descripcion} </td>
<td>${articulosTemp.stock} </td>
<td>${articulosTemp.precio} </td>
<td><a href="${linkActualizarA}"><button type="button" class="btn btn-primary btn-lg">Modificar</button></a></td>
<td><a href="${linkEliminarA}"><button type="button" class="btn btn-danger btn-lg" onclick="if(!(confirm('Vas a eliminar un registro.¿Estas seguro?'))) return false"/>Eliminar</button></a></td>
</tr>
</c:forEach>
</table>
<br>
...
<button class="btn btn-outline-primary" type="button" onclick="window.location.href='muestraFormularioAgregarA'; return false;">Agregar Artículo</button>
</center>
<br>
<br>
<br>
