  ...
  <hr>
   ...
   <form:form action="insertarArticulo" modelAttribute="articulo" method="POST">   
     ...
     <table border="1">
      ...
      <tr>
     <td id="cabecera">descripcion</td><td><form:input path="descripcion" /></td>
     </tr>
     <tr>
     <td id="cabecera">stock</td><td><form:input path="stock" /></td>
     </tr>
     <tr>
     <td id="cabecera">precio</td><td><form:input path="precio" /></td>
     </tr>
     <tr>
...
<br>
<br>
<button class="btn btn-outline-dark" onclick="window.location.href='lista3';" type="button">Regresar</button>
</center>
<br>
<br>
<br>
